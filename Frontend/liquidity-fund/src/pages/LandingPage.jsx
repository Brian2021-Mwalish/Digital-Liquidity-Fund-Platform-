    ...
    <div className="bg-white text-gray-800 font-sans overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-16 bg-gradient-to-br from-emerald-600 via-green-500 to-emerald-600">
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          <div>
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-black mb-6 leading-tight text-white drop-shadow-lg">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl max-w-4xl mx-auto mb-10 text-gray-100 font-light leading-relaxed drop-shadow-md">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button 
                onClick={handleGetStarted}
                className="group relative bg-white text-emerald-600 font-bold px-8 py-4 rounded-2xl hover:bg-yellow-400 hover:text-white transition-all duration-500 transform hover:scale-110 hover:shadow-2xl"
              >
                Open Your Investment Account
              </button>
              <button className="border-2 border-white text-white font-semibold px-8 py-4 rounded-2xl hover:bg-white hover:text-emerald-600 transition-all duration-300 transform hover:scale-105">
                Watch Demo
              </button>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="group relative bg-white p-8 rounded-3xl shadow-lg hover:shadow-2xl transform transition-all duration-500 hover:scale-105 border border-gray-100"
              >
                <div className={`w-16 h-16 bg-gradient-to-r ${step.color} rounded-2xl flex items-center justify-center text-2xl text-white font-bold mb-6 group-hover:scale-110 transition-transform duration-300`}>
                  {index + 1}
                </div>
      ...
      <section id="referrals" className="relative py-16 sm:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden bg-gradient-to-br from-yellow-400 via-yellow-500 to-orange-500">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-lg sm:text-xl text-white text-opacity-90 mb-8 max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="grid sm:grid-cols-3 gap-6 text-white">
            ...
            <div className="bg-white bg-opacity-10 p-6 rounded-2xl backdrop-blur-sm">
              ...
              <div className="text-sm opacity-90">Payout Time</div>
            </div>
            <div className="bg-white bg-opacity-10 p-6 rounded-2xl backdrop-blur-sm">
              <div className="text-3xl font-bold">Unlimited</div>
              <div className="text-sm opacity-90">Referral Limit</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={index}
                className="group bg-gray-800 bg-opacity-50 p-6 rounded-2xl border border-gray-700 hover:border-emerald-500 transform hover:scale-105 transition-all duration-500 backdrop-blur-sm"
              >
                <div className={`w-12 h-12 bg-gradient-to-r ${module.color} rounded-xl flex items-center justify-center text-xl font-bold mb-4 group-hover:scale-110 transition-transform duration-300`}>
                  {index + 1}
                </div>
      ...
      <section className="bg-gradient-to-r from-emerald-600 via-green-500 to-emerald-600 text-white py-20 text-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button 
              onClick={handleGetStarted}
              className="bg-white text-emerald-600 px-10 py-4 rounded-2xl font-bold hover:bg-yellow-400 hover:text-white transition-all duration-500 transform hover:scale-110 hover:shadow-2xl"
            >
              Get Started Now
            </button>
            <button 
              onClick={handleLogin}
              className="border-2 border-white text-white font-semibold px-10 py-4 rounded-2xl hover:bg-white hover:text-emerald-600 transition-all duration-300"
            >
